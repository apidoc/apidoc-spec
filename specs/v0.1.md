...
[Example file](https://github.com/apidoc/apidoc-spec/examples/v0.1/api_data.json)
...
Contains variable named arrays. The _name_ is the group of a field.

The _name_ could be empty `""`, if no grouping is needed.

| Name | Type | Description |
| ---- | ---- | ----------- |
| _name_ | [Field](#field-object) | Field object. |

Example: `"My Group"` is the variable _name_
...
[Example file](https://github.com/apidoc/apidoc-spec/examples/v0.1/api_project.json)
